  ...
  return (
    <div className="fixed inset-0 z-20 flex flex-col items-center justify-center [font-family:var(--font-plus-jakarta)]"
      ...
      <div className="text-center px-8">
        ...
        <p className="text-[#a9cfb6] tracking-[0.4em] font-display text-xs uppercase mb-4">Enrollment Confirmed</p>
        <h1 className="text-white font-display text-4xl md:text-5xl leading-tight mb-6">You&apos;re In</h1>
